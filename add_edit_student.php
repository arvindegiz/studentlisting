    ...
    <?php
      ...
      <div class="row mb-3">
       ...
       <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input name="class" type="number" class="form-control" id="" value="<?php if(isset($_GET['id'])){ echo $data['class']; } ?>" required>
        </div>
      </div>
       ...
       <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input name="roll_no" type="number" class="form-control" id="" value="<?php if(isset($_GET['id'])){ echo $data['roll_no']; } ?>" required>
        </div>
      </div>
...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO students (name, class, roll_no,created_at)
  VALUES ('$name',  '$class' , '$roll_no' , '$created_at')";
...
if(isset($_POST['edit_submit'])){
  ...
  $sql = "UPDATE students set name = '$name', class = '$class',  roll_no = '$roll_no' where id = '$id'";
